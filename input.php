...
$s_fullname = $s_age = $s_address = $_gioitinh = '';
...
if (!empty($_POST)) {
	...
	if ($s_id != '') {
		//update
		$sql = "update nhansu set fullname = '$s_fullname', age = '$s_age', address = '$s_address' where id = " .$s_id;
	} else {
		//insert
		$sql = "insert into nhansu(fullname, age, address) value ('$s_fullname', '$s_age', '$s_address')";
	}
	...
	<div class="container">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h1 style="text-align: center; margin: 50px" class="text-center">Thêm thông tin</h1>
			</div>
			<div class="panel-body">
				<form method="post">
					<div class="form-group">
					  <label style="font-weight: bold;" for="usr">Tên:</label>
					  <input type="number" name="id" value="<?=$id?>" style="display: none;">
					  <input required="true" type="text" class="form-control" id="usr" name="fullname" value="<?=$s_fullname?>">
					</div>

					<div class="form-group">
					  <label style="font-weight: bold;" for="birthday">Tuổi:</label>
					...
					<a href="index.php" style="background-color:red;" class="btn btn-success">Về trang chủ</a>	
				</form>
			</div>
		</div>
	</div>
